...
# 验证配置是否生效
grep "CONFIG_PACKAGE_luci-app-mosdns" .config || echo "错误：mosdns 未启用！"
grep "CONFIG_PACKAGE_luci-app-overview-widgets" .config || echo "错误：luci-app-overview-widgets 未启用！"
